...
Devise.setup do |config|
  ...
  # Prefer SECRET_KEY_BASE so Devise does not probe encrypted credentials when
  # a developer .env has a malformed RAILS_MASTER_KEY (migration Compose sets this).
